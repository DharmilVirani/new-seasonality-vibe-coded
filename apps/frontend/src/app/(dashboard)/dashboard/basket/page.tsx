...
export default function BasketPage() {
  const { startDate, endDate, availableSymbols } = useAnalysisStore();
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            <Label>Add Symbol to Basket</Label>
          ...
          <div className="space-y-2">
            <Label>Selected Symbols ({basketSymbols.length})</Label>
            <div className="flex flex-wrap gap-2">
              {basketSymbols.map((symbol) => (
                ...
                >
                  {symbol}
                  <button onClick={() => removeSymbol(symbol)} className="hover:text-destructive">
                    <X className="h-3 w-3" />
                  </button>
                </span>
              ))}
