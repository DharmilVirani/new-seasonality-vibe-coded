...
import { SymbolSelector, DateRangePicker, YearFilters, MonthFilters } from '@/components/filters';
        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-muted-foreground px-2 py-0.5 bg-muted rounded">Monthly Analysis</span>
            </div>
...
function ChartOnly({ data, chartScale, symbol }: { 
  ...
  const chartData = useMemo(() => {
    ...
    return data.map((d: any) => {
      ...
      return {
        ...d,
        label: d.monthLabel || d.label || new Date(d.date).toLocaleDateString('en-IN', { month: 'short', year: '2-digit' }),
    ...
    <div className="h-full w-full">
      <ResponsiveContainer width="100%" height="100%">
        <AreaChart data={chartData} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
          <defs>
            <linearGradient id="colorReturnMonthly" x1="0" y1="0" x2="0" y2="1">
