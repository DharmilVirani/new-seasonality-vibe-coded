#!/usr/bin/env node
/**
 * Special Days Data Migration Script (JavaScript version)
 * Migrates data from old-software/SpecialDays/SpecialDays.csv to the database
 * 
 * Usage: npm run migrate:special-days (from apps/backend directory)
 */

// Change to backend directory to access Prisma
process.chdir(__dirname + '/../apps/backend');
...
const getCategoryAndCountry = (name) => {
